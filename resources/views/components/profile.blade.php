                    ...
                    <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if ($user->foto_profile)
                                <div class="mb-2">
                                    <img src="{{ Storage::url('file_fotoprofile/' . $user->foto_profile) }}"
                                        alt="Foto Profil" class="img-thumbnail" style="max-width: 250px;">
                                </div>
                            @endif
                        ...
                        <div class="mb-3">
                            ...
                            <label for="changePassword" class="form-label fw-bold text-secondary">Ubah Password</label>
                        </div>

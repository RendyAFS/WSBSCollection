<nav class="navbar navbar-expand-lg px-4 mt-3">
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <div class="dropdown ms-auto" id="drowpdown-account">
            <button class="btn btn-soft-grey d-flex account fw-bold"  type="button" data-bs-toggle="dropdown" aria-expanded="false">

...
@section('content')
    ...
    <div id="chartpelangganbillperexisting"></div>
@endsection
...
@push('scripts')
    <script type="module">
        ...
        var chart = new ApexCharts(document.querySelector("#chartpelangganbillperexisting"), options);
        chart.render();
    </script>
@endpush
